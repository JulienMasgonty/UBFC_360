...
<main class="listing-page">
	...
	<?php endwhile; ?>
		<section class="liste-mode-emploi">
			<?php 
				$args = array (
					'post_type'	=> 'mode-emploi',
					'orderby'	=> 'title'
				);
			...
			?>
				<?php 
					$files = rwmb_meta('pdf-m-emploi');
					foreach($files as $file):				?>
					<a target="_blank" href="<?php echo $file['url'] ?>" class="etab">
						<?php 
							$images = rwmb_meta('img-m-emploi', 'type=image_advanced&size=full');
							foreach($images as $image):
						?>
							<img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
						<?php endforeach; ?>
						<p>
							<?php echo rwmb_meta('titre-m-emploi'); ?>
						</p>
					</a>
					<?php endforeach; ?>
			<?php endwhile; ?>
